...
public class TestDb extends AndroidTestCase {
    ...
    public void testCreateDb() throws Throwable {
        ...
        locationColumnHashSet.add(MovieContract.MovieEntry.POSTER);
        locationColumnHashSet.add(MovieContract.MovieEntry.BACKDROP);
        locationColumnHashSet.add(MovieContract.MovieEntry.OVERVIEW);
        locationColumnHashSet.add(MovieContract.MovieEntry.VOTE);
